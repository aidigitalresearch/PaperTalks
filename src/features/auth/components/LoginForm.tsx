 ...
 * 
 * Handles email/password login and OAuth options.
 */
...
import { signIn, signInWithMagicLink, signInWithGoogle } from '../actions';
...
export function LoginForm() {
  ...
  const [formError, setFormError] = useState<string | null>(error ? 'Authentication failed. Please try again.' : null);
  ...
  if (magicLinkSent) {
    return (
      <div className="text-center">
        ...
        <h2 className="font-serif text-2xl font-semibold text-stone-900">Check your email</h2>
    ...
    <div className="w-full max-w-sm mx-auto">
      ...
      <div className="text-center mb-8">
        ...
        <p className="mt-2 text-sm text-stone-600">
          Sign in to your research profile
        </p>
      </div>
      ...
      <div className="space-y-3">
        ...
        {/* TODO: Enable ORCID when configured in Supabase
        <form action={signInWithOrcid}>
          <Button
            ...
            disabled={isLoading}
          >
            <span className="w-5 h-5 mr-2 bg-[#A6CE39] rounded text-white text-xs font-bold flex items-center justify-center">iD</span>
            Continue with ORCID
          </Button>
        </form>
        */}
